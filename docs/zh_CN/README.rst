    ...
    <embed>
      <table border='1' style="border-collapse:collapse" class='tables'>
         ...
         <tr>
            ...
            <td>
               <ul>
                 <li><a href="docs/weidentity-installation.html">安装部署文档</a></li>
                 <li><a href="docs/weidentity-java-sdk-doc.html">SDK使用文档</a></li>
               </ul>
            </td>
            <td>
...
*
   详见：\ `如何贡献 <https://github.com/webankopen/WeIdentity/blob/master/.github/CONTRIBUTING.md>`_
