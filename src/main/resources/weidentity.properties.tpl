...
datasource.name=datasource1,datasource2
...
datasource2.jdbc.url=jdbc:mysql://0.0.0.0:3306/mysql?useUnicode=true&characterEncoding=utf-8&allowMultiQueries=true&useSSL=false
datasource2.jdbc.username=user
datasource2.jdbc.password=password
datasource2.jdbc.maxActive=50
datasource2.jdbc.minIdle=5
datasource2.jdbc.maxIdle=5
datasource2.jdbc.maxWait=10000
datasource2.jdbc.timeBetweenEvictionRunsMillis=600000
datasource2.jdbc.numTestsPerEvictionRun=5
datasource2.jdbc.minEvictableIdleTimeMillis=1800000
...
# example:
# credential.domain=datasource2:credential_data
# weidDocument.domain=datasource2:weid_document_data
