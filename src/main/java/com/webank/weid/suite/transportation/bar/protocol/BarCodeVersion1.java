 ...
 *
 */
public class BarCodeVersion1 extends TransCodeBaseData {
    
    private static final Logger logger = LoggerFactory.getLogger(BarCodeVersion1.class);
